    ...
    <div id="mediaplayer_node">
      <div id="mediaplayer_menu">
        ...
        <div id="mediaplayer_embed" class="mediaplayer_info">
          <div id="mediaembedForm" name="mediaembedForm">
            ...
            <input id="mediaembedCode" name="mediaembedCode" type="text" value="" readonly="readonly" />
          </div>
        </div>
        <div id="mediaplayer_link" class="mediaplayer_info">
          <div id="mediaelinkForm" name="mediaelinkForm">
            ...
            <input id="mediaelinkCode" name="mediaelinkCode" type="text" value="" readonly="readonly" />
          </div>
        </div>
      ...
      <div id="mediaplayer_minplayer">
        <div id="mediaplayer_busy">
          <img src="<?php print $params['playerURL']; ?>/templates/simpleblack/images/busy.gif" alt="" width="16" height="16" />
        </div>
        <div id="mediaplayer_bigPlay">
          <img src="<?php print $params['playerURL']; ?>/templates/simpleblack/images/mediafront_bigplay.png" alt="" width="16" height="16" />
        </div>
