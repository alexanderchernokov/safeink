...
{
	if ((strpos($package['headers_mixed']['User-Agent'], "Windows Live Writer") === FALSE) &&
	...
	if (!array_key_exists('Akamai-Origin-Hop', $package['headers_mixed']) && strpos($package['headers_mixed']['User-Agent'], "IEMobile") === FALSE && (isset($package['headers_mixed']['Connection']) && @preg_match('/\bTE\b/i', $package['headers_mixed']['Connection']))) {
		return "2b90f772";
	}
