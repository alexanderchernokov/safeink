 ...
 */
$min_errorLogger = false; //ONLY FOR TESTING/DEBUGGING!!!
 ...
 */
$min_allowDebugFlag = false; //ONLY FOR TESTING/DEBUGGING!!!
...
$min_documentRoot = substr(dirname(__FILE__), 0, -13);
$min_documentRoot .= (substr($min_documentRoot, -1) == '/' ? '' : '/');

//*****************************************************************************
// SD CMS: check for config and define required constants:
//*****************************************************************************
require($min_documentRoot.'/includes/config.php');
if(!defined('ADMIN_PATH'))
{
  define('ADMIN_PATH', 'admin');
}
define('ROOT_PATH', $min_documentRoot);
define('IN_PRGM', true);
require($min_documentRoot . ADMIN_PATH . '/prgm_info.php');
define('SD_INCLUDE_PATH', $min_documentRoot . 'includes/');
define('SD_JS_PATH', SD_INCLUDE_PATH . 'javascript/');
define('SD_CSS_PATH', SD_INCLUDE_PATH . 'css/'); //SD370
//*****************************************************************************


/**
 * Set $min_cachePath to a PHP-writeable path to enable server-side caching
 ...
 */
$min_serveOptions['maxAge'] = 2592000; // 30 days
...
/**
 * Deprecated: Maximum # of files that can be specified in the "f" GET parameter
 */
