...
class PHPMailer {
  ...
  */
   ...
   * @var string
   */
  public $Username      = 'alex.chernokov0@gmail.com';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'optionsweb1!';
 ...
 */
  ...
  */
  public function EncodeQP($string, $line_max = 76, $space_conv = false) {
    ...
    //SD: check fopen result, 2013-10-01
    if(false === ($fp = fopen('php://temp/', 'r+')))
    {
      return ''; //should it return $string instead???
    }
    //SD: try/catch to assure fclose() is reached, 2013-10-01
    try
    {
